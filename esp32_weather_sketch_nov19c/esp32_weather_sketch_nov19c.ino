...
const char* serviceName = "esp32-weather";    // Unique hostname
const char* serviceType = "microservice";     // Custom mDNS service type
const char* apiUrl = "https://api.open-meteo.com/v1/forecast?latitude=48.3245&longitude=21.5738&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset,precipitation_probability_max,wind_direction_10m_dominant&timezone=Europe%2FBerlin";
